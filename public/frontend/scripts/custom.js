...
$( document ).ready(function() {
    ...
    if($('#content .content .heading-title').length){
        var mypht=$('<img src="/frontend/images/syres-victoria4.jpg" style="max-height:90px;display:inline-block;margin:0 0 0 25px;vertical-align:middle;border-radius:60px;">');

        $('#content').find('.heading-title').append(mypht);
