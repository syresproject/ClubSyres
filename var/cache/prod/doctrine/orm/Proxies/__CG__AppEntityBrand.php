...
class Brand extends \App\Entity\Brand implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Brand' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Brand' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Brand' . "\0" . 'clubArticles', '' . "\0" . 'App\\Entity\\Brand' . "\0" . 'categoryHabit', '' . "\0" . 'App\\Entity\\Brand' . "\0" . 'visible'];
        }
