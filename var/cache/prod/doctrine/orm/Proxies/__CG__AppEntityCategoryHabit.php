 ...
 */
class CategoryHabit extends \App\Entity\CategoryHabit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\CategoryHabit' . "\0" . 'id', '' . "\0" . 'App\\Entity\\CategoryHabit' . "\0" . 'name', '' . "\0" . 'App\\Entity\\CategoryHabit' . "\0" . 'visible', '' . "\0" . 'App\\Entity\\CategoryHabit' . "\0" . 'headerHabits', '' . "\0" . 'App\\Entity\\CategoryHabit' . "\0" . 'clubArticles', '' . "\0" . 'App\\Entity\\CategoryHabit' . "\0" . 'brands'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CategoryHabit $proxy) {
    ...
    public function addHeaderHabit(\App\Entity\HeaderHabit $headerHabit)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addHeaderHabit', [$headerHabit]);

        return parent::addHeaderHabit($headerHabit);
    }
    ...
    public function removeHeaderHabit(\App\Entity\HeaderHabit $headerHabit)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeHeaderHabit', [$headerHabit]);

        return parent::removeHeaderHabit($headerHabit);
    }
    ...
    public function getHeaderHabits()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHeaderHabits', []);

        return parent::getHeaderHabits();
    }
