...
class Configuration extends \App\Entity\Configuration implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Configuration' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Configuration' . "\0" . 'facebook', '' . "\0" . 'App\\Entity\\Configuration' . "\0" . 'insta', '' . "\0" . 'App\\Entity\\Configuration' . "\0" . 'site'];
        }
    ...
    public function getInsta()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getInsta', []);

        return parent::getInsta();
    }
    ...
    public function setInsta(string $insta)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInsta', [$insta]);

        return parent::setInsta($insta);
    }
