...
class Contact extends \App\Entity\Contact implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Contact' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Contact' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Contact' . "\0" . 'subject', '' . "\0" . 'App\\Entity\\Contact' . "\0" . 'content', '' . "\0" . 'App\\Entity\\Contact' . "\0" . 'idPaneliste', '' . "\0" . 'App\\Entity\\Contact' . "\0" . 'lastname', '' . "\0" . 'App\\Entity\\Contact' . "\0" . 'firstname'];
        }
