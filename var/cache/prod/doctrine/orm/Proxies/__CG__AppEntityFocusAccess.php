 ...
 */
class FocusAccess extends \App\Entity\FocusAccess implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\FocusAccess' . "\0" . 'id', '' . "\0" . 'App\\Entity\\FocusAccess' . "\0" . 'access', '' . "\0" . 'App\\Entity\\FocusAccess' . "\0" . 'user', '' . "\0" . 'App\\Entity\\FocusAccess' . "\0" . 'focusGroup'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FocusAccess $proxy) {
