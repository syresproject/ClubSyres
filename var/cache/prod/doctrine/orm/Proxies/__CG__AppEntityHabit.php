 ...
 */
class Habit extends \App\Entity\Habit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Habit' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Habit' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Habit' . "\0" . 'visible', '' . "\0" . 'App\\Entity\\Habit' . "\0" . 'headerHabit', '' . "\0" . 'App\\Entity\\Habit' . "\0" . 'clubArticles'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Habit $proxy) {
